        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <NavLink className="nav-link" to="/smessages">
                  Messages
                </NavLink>
              </li>
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li>
                    <NavLink className="dropdown-item" to="/interests">
                      Interests
                    </NavLink>
                  </li>
                  <li>
                    <NavLink className="dropdown-item" to="/createSearch">
                      Opportunities
                    </NavLink>
                  </li>
                  <li>
              ...
              <li className="nav-item">
                <NavLink className="nav-link" to="/ssignup">
                  Signup
                </NavLink>
              </li>
            </ul>
