    ...
    <div className="desktop-1">
      <div className="frame">
        ...
        <div className="if-you-have-container">
          ...
          <p className="blank-line">&nbsp;</p>
          <p className="blank-line">
            If you have a project in mind and you're looking for collaborators,
            you can use our platform to post your project requirements. Explain
            your project's details, and the skills you're looking for in
            potential collaborators. Posting a project is easy and can help you
            find the right team.
          </p>
        </div>
        ...
        <div className="our-quiz-feature">
          ...
          performance. Perfect for education, team activities,
          and entertainment.
        </div>
      </div>
